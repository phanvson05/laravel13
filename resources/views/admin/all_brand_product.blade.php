                        ...
                        @foreach($all_brand_product as $key => $brand_pro)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="return confirm('Bạn có chắc là muốn xóa danh mục này ko?')" ref="{{URL::to('/delete-brand-product/'.$brand_pro->brand_id)}}" class="activestyling-edit" ui-toggle-class="">
